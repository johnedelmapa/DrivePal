...
public class CreateVehicle2 extends AppCompatActivity implements View.OnClickListener, OnItemSelectedListener {
                        ...
                        FirebaseDatabase.getInstance().getReference("Vehicles/VehicleTwo/VehicleInfo")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    //finish();
                                    Toast.makeText(CreateVehicle2.this, "Vehicle Registered Successfully", Toast.LENGTH_SHORT).show();
                                } else {
